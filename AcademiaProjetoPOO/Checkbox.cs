...
public class Checkbox
{
    ...
    public void Show()
    {
        ...
        Console.WriteLine("(Use as Setas do teclado para navegar para cima e para baixo, barra de Espaço para selecionar e Enter para submeter.)");

        foreach (var option in _options)
        {
            Console.ForegroundColor = option.Selected
                ? (option.Hovered ? ConsoleColor.Green : ConsoleColor.DarkGreen)
                : (option.Hovered ? ConsoleColor.Blue : ConsoleColor.DarkGray);
